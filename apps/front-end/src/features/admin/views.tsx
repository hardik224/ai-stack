      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/75 p-4 backdrop-blur-md">
          <Card className="w-full max-w-2xl p-6">
            <SectionHeading eyebrow="New upload" title="Add source files" description="Upload one or more PDFs or CSVs and the system will place them into the right managed knowledge space automatically. You do not need to choose a collection." />
